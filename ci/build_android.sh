...
# -DANDROID_NDK_API_VERSION=19 is there because application built with 
# Android NDK 21 is not compatible with older devices.
cmake -DCMAKE_TOOLCHAIN_FILE=$CMAKE_FILE -DCACHE_SIZE='(20*1024*1024)' \
	-DAVOID_FLOAT=1 -DSAMPLE_MAP=n -DBUILD_MAPTOOL=n \
	-DANDROID_API_VERSION=21 -DANDROID_NDK_API_VERSION=19 $SOURCE_PATH
make || exit 1
